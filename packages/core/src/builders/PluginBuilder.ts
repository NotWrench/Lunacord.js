...
export class PluginBuilder {
  ...
  beforeRestRequest(
    ...
    ) => Promise<RestRequestPatch | undefined> | RestRequestPatch | undefined
  ): PluginBuilder {
    return new PluginBuilder(this.client, this.plugin, {
      ...this.plugin,
  ...
  onPlayerRestore(hook: NonNullable<LunacordPlugin["onPlayerRestore"]>): PluginBuilder {
    return new PluginBuilder(this.client, this.plugin, {
      ...this.plugin,
      onPlayerRestore: hook,
    });
  }
