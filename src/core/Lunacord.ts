...
import { LyricsClient } from "../integrations/lyrics/LyricsClient";
...
import type { LyricsOptions, LyricsRequestOptions, LyricsResult } from "../types";
...
export class Lunacord extends TypedEventEmitter<LunacordEvents> {
  ...
  private bindNodeEvents(node: Node): void {
    ...
    node.on("ready", (payload) => {
      ...
      void this.pluginManager.startAll();
      if (!payload.resumed) {
