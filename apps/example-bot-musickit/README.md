# Lunacord — Example Bot (MusicKit)

Batteries-included music bot in about 15 lines of meaningful code using [`@lunacord/discordjs`](../../packages/discordjs) and `MusicKit`.
